...
public final class NewsCollectionSchema {
    ...
    public static final String DISPLAY_NAME = "Haberler";
    ...
    public static final CollectionSchema SCHEMA = new CollectionSchema(List.of(
            ...
            FieldDefinition.of("attachments", FieldType.OBJECT_ARRAY, "Ekler")
                    ...
                    .withHelp("Habere eklenecek dosyalar: dilekçe, form, sınav takvimi. Dosyayı sürükleyip bırakın; Word ve Excel dosyaları okuyucuya indirmeden gösterilir."),
